/* src/components/camera/LightMeterScaleDisplay/LightMeterScaleDisplay.tsx */
import { useCameraStore } from "../../../stores/cameraStore";
import styles from "./LightMeterScaleDisplay.module.css";

export default function LightMeterScaleDisplay() {
